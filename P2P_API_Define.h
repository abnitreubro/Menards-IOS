...
#define MSG_TYPE_SDCARD_RECORD      0x29
...
typedef  struct tag_STRU_RUNCAR_SDCARD_RECORD{
    char user[64];
    char pwd[64];
    int status;
}STRU_RUNCAR_SDCARD_RECORD,*PSTRU_RUNCAR_SDCARD_RECORD;

#define MAX_RECORD_FILE_COUNT 100
