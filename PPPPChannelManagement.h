...
public:
    ...
    void SetCameraViewDelegate(id delegate);
    
    int SetRunCarDelegate(char *szDID,id delegate);
    int SetRunCarDownloadDelegate(char *szDID,id delegate);
    int SetRunCarRemoteDownloadDelegate(char *szDID,id delegate);
    
    int SetSDcardRecordParams(char *szDID,char *user ,char *pwd ,int status);
    int setPlayStatusDelegate(char *szDID,id delegate);
public:
...
private:
    ...
    NSCondition *m_CameraViewDelegateLock;
};
