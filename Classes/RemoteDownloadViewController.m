//
//  RemoteDownloadViewController.m
//  P2PCamera
//
...
#import "obj_common.h"
@interface RemoteDownloadViewController ()

@end

@implementation RemoteDownloadViewController
...
- (void)viewDidLoad
{
    ...
    UINavigationItem *item=[[UINavigationItem alloc]initWithTitle:NSLocalizedStringFromTable(@"runcar_remote_download", @STR_LOCALIZED_FILE_NAME, nil)];
...
-(void)tableView:(UITableView *)atableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (isEdit) {
        ...
        [self getFilePath:[arr objectAtIndex:indexPath.row]];
    }
